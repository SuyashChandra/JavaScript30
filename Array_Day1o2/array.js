  // Get your shorts on - this is an array workout!
    ...
    const inventors = [
      ...
      const fifteen = inventors.filter(investor => (investor.year<1600 && investor.year>=1500)  );
      ...
      const totalAge = inventors.reduce((total, investor) => {
    ...
    //   const list = [...div.querySelectorAll('a')]
    //   const de = list
    ...
    //   console.log(de)
      ...
      // Sort the people alphabetically by last name
        const last = inventors
                        .map(inventor => inventor.last)
                        .sort((a, b) => a > b ? 1 : -1);
        console.table(last)
      // 8. Reduce Exercise
